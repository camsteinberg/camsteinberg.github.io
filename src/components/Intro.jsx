...
function Intro() {
    return (
        ...
        pb-12">
            ...
            font-bold pt-2">I am an undergraduate student at Brandeis University, who is currently pursuing a double major in Computer Science and Business. I am incredibly passionate, driven and curious about Web/Software Development, as well as Data Analytics. I am a hardworking and social person, who loves working and collaborating with others to bring creative visions to life.
            <br></br>
